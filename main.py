...
async def mcstatus(ctx):
    ...
    try:
        embed.set_thumbnail(
            url="https://images-ext-2.discordapp.net/external/or7mN4DQa7IqfuCuN8XTP3OQLlwx1hMTn0Cdq_qwWaM/https/eu.mc-api.net/v3/server/favicon/mincreft22.aternos.me%3A61553?width=80&height=80")
    except:
